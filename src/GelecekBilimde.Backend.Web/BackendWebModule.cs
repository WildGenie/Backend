...
using GelecekBilimde.Backend.Web.Menus;
    ...
    public class BackendWebModule : AbpModule
    {
        public override void PreConfigureServices(ServiceConfigurationContext context)
        {
            context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
            {
                options.AddAssemblyResource(
                    typeof(BackendResource),
                    typeof(BackendDomainSharedModule).Assembly,
                    typeof(BackendApplicationContractsModule).Assembly,
                    typeof(BackendWebModule).Assembly
                );
            });
        }
        ...
        private void ConfigureAutoMapper()
        {
            Configure<AbpAutoMapperOptions>(options =>
            {
                 ...
                 */
                options.AddProfile<BackendWebAutoMapperProfile>();
            });
        }
        ...
        private void ConfigureVirtualFileSystem(IHostingEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<BackendDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}GelecekBilimde.Backend.Domain"));
                    ...
                    options.FileSets.ReplaceEmbeddedByPhysical<BackendWebModule>(hostingEnvironment.ContentRootPath);
                });
            }
        }
        ...
        private void ConfigureNavigationServices()
        {
            ...
            {
                options.MenuContributors.Add(new BackendMenuContributor());
            });
        }
